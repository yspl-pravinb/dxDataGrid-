        ...
        */
        ...
        columns: [
            ...
            },
            {
                ...
                validationRules: [{
                    type: 'stringLength',
                    message: 'The field ShipName must be a string with a maximum length of 40.',
                    max: 40,
                }],
        ...
        {
            // Set the default grouping column
            e.component.columnOption("CustomerID", "groupIndex", 0);
        },
